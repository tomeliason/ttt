...
resource oci_identity_compartment CANDD {
  compartment_id = "${var.tenancy_ocid}"
  description = "CANDD"
  name = "CANDD"
}
...
resource oci_identity_group CANDD {
  compartment_id = "${var.tenancy_ocid}"
  description = "CANDD"
  freeform_tags = {}
  name = "CANDD"
...
resource oci_identity_policy CANDD {
  ...
  name = "CANDD_Policy"
  statements = [
    "allow group CANDD to manage all-resources in compartment CANDD",
    "allow group CANDD to use tag-namespaces in tenancy",
    "allow group CANDD to manage repos in tenancy",
  ]
}
...
output "oci_identity_compartment" {
  ...
  value = oci_identity_compartment.CANDD.id 
}
