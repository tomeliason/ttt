...
resource oci_identity_compartment CMS {
  compartment_id = "${var.tenancy_ocid}"
  description = "CMS"
  name = "CMS"
}
...
resource oci_identity_group CMS {
  compartment_id = "${var.tenancy_ocid}"
  description = "CMS"
  freeform_tags = {}
  name = "CMS"
...
resource oci_identity_policy CMS {
  ...
  name = "CMS_Policy"
  statements = [
    "allow group CMS to manage all-resources in compartment CMS",
    "allow group CMS to use tag-namespaces in tenancy",
    "allow group CMS to manage repos in tenancy",
  ]
}
...
output "oci_identity_compartment" {
  ...
  value = oci_identity_compartment.CMS.id 
}
